#!/usr/bin/perl -w
#use lib '/media/StorageOne/HTS/viralmeta_bioifo/public_programs/VirusFinder2.0/bin';
use strict;
use Carp;
use Getopt::Long;
use English;
...
2. Bio::DB::Sam, version 1.5 or later, it requires /media/StorageOne/HTS/viralmeta_bioifo/public_programs/samtools-0.1.18/samtools lib installed.
