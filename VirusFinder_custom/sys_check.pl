...
# 07/19/2013   Code added to check /media/StorageOne/HTS/viralmeta_bioifo/public_programs/samtools-0.1.18/samtools
##############################################################################
...
$ret = `which /media/StorageOne/HTS/viralmeta_bioifo/public_programs/samtools-0.1.18/samtools 2>&1`;
if (index($ret, 'no /media/StorageOne/HTS/viralmeta_bioifo/public_programs/samtools-0.1.18/samtools') == -1) {
    printf "%-30s\tOK\n\n", 'SAMtools';
}else{
