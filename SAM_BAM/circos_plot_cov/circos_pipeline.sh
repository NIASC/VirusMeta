...
##########################
cp -r $path_htsa_dir/VirusMeta/SAM_BAM/circos_plot_cov  $1/circos_plot_cov
##
...
#$path_htsa_dir/VirusMeta/SAM_BAM/BWA_NR.sh $1/b_actine_map $1/circos_plot_cov/b_actine.fasta $2 $3
