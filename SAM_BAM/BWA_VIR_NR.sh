...
#python /media/storage/HTS/viralmeta_bioifo/SAM_BAM/run_parallel_pysam.py --input_file=aln-pe.bam --query_fasta=$work_fasta  --result_file=$work_fasta.txt --jobs 70 --temp_directory=tmp
