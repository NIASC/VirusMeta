...
cp -r $path_htsa_dir/VirusMeta/SAM_BAM/beta_actine_test  $project_work_dir/beta_actine_test
##
...
#$path_htsa_dir/VirusMeta/SAM_BAM/BWA_NR.sh $project_work_dir/beta_actine_map $project_work_dir/beta_actine_test/beta_actine.fasta $2 $3
