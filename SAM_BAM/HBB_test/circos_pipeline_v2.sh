#!/bin/sh
# /media/StorageOne/HTS/viralmeta_bioifo/SAM_BAM/HBB_test/circos_pipeline_v2.sh /media/StorageOne/HTS/Projects/2013_H5_RNA-NMSC_v3 /media/StorageOne/HTS/Projects/2013_H5_RNA-NMSC_v3/CaskiRNA.read1.fastq.gz /media/StorageOne/HTS/Projects/2013_H5_RNA-NMSC_v3/CaskiRNA.read2.fastq.gz
##########################
...
/usr/local/bin/bwa mem $work_fasta $PAIR1 $PAIR2 -t 20 | /usr/local/bin/samtools view -@ 20 -b -S - > aln-pe.bam
