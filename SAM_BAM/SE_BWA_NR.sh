...
python /media/storage/HTS/VirusMeta/SAM_BAM/run_parallel_pysam.py --input_file=aln-pe.bam --query_fasta=$work_fasta.txt  --result_file=$work_fasta.txt --jobs 70 --temp_directory=tmp
