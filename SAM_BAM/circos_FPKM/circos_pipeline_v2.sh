...
cp -r $path_htsa_dir/VirusMeta/SAM_BAM/circos_FPKM  $project_work_dir/circos_FPKM
##
...
#$path_htsa_dir/VirusMeta/SAM_BAM/BWA_NR.sh $project_work_dir/FPKM_map $project_work_dir/circos_FPKM/beta_actine.fasta $2 $3
...
for gene in 'ACTB' 'CAPDH'  'DLX5'  'HBB' 'HPV16'  'KRT2'  'PUM1'  'TP63'  'TP73'; do
    ...
    ' $path_htsa_dir/VirusMeta $gene $gene $gene $gene > $gene.FPKM.R
