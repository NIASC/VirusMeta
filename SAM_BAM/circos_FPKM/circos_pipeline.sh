...
# /media/StorageOne/HTS/viralmeta_bioifo/SAM_BAM/circos_FPKM/circos_pipeline_v2.sh /media/storage/HTS/Projects/2013_H7_RNA-2libr /media/storage/HTS/Projects/2013_H7_RNA-2libr/diginorm/read_1.fastq /media/storage/HTS/Projects/2013_H7_RNA-2libr/diginorm/read_2.fastq
##########################
export project_work_dir=$1
export path_htsa_dir=/media/storage/HTS
##########################
cp -r $path_htsa_dir/viralmeta_bioifo/SAM_BAM/beta_actine_test  $1/beta_actine_test
##
...
#$path_htsa_dir/viralmeta_bioifo/SAM_BAM/BWA_NR.sh $1/b_actine_map $1/beta_actine_test/b_actine.fasta $2 $3
...
perl /media/storage/HTS/viralmeta_bioifo/public_programs/circos-0.64/bin/circos  -conf etc/circos.conf
