...
#/media/StorageOne/HTS/VirusSlayer/ffp/ffp_step1.sh /media/StorageOne/HTS/PublicData/nt_pb/virus_block_ffp_7 /media/StorageOne/HTS/PublicData/nt_pb/family 7
