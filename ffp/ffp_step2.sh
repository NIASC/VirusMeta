...
#/media/StorageOne/HTS/VirusMeta/ffp/ffp_step3.sh /media/StorageOne/HTS/PublicData/nt_pb/virus_genomes_ffp_7 /media/StorageOne/HTS/PublicData/nt_pb/virus_block_ffp_7 genomes /media/StorageOne/HTS/PublicData/nt_pb/ssDNA_viruses_clean.gi
...
then
  #create shell script that will select specific genomes ffp(s)
   awk -v step1_dir=$step1_dir '{print "cp  "step1_dir"/*."$1".ffp ."}' $list_file > select_genomes.sh
