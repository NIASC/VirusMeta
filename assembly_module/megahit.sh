...
for kmer in 65; do #60 70
    $path_htsa_dir/$path_pipeline/public_programs/megahit/megahit -1 $diginorm_work_dir/read_1.fastq -2 $diginorm_work_dir/read_2.fastq -o out.$kmer --cpu-only --k-min 19 --k-max 31 --k-step 4 --num-cpu-threads 10 --memory 0.4 --min-count 2  -l $kmer
