...
#sudo /media/storage/HTS/VirusMeta/seq_corret_module/custom_db_bast.sh query_fasta check_fasta_dir custom_check_working_dir
...
python $path_htsa_dir/VirusMeta/blast_module/run_parallel_xml_parser.py --input_file=custom.xml --result_file=custom_final.blast_results --out_gi=custom_gi.blast_results  --temp_directory=custom_tmp --jobs=70
